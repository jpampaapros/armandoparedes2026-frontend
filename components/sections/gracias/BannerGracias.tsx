  ...
  return (
    <section className="relative h-672 w-full overflow-hidden md:h-700">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-1440 flex-col items-center px-16 pt-116 text-center md:items-start md:px-80 md:pt-58 md:text-left">
        ...
        {titulo && (
          <h1
            className="mt-110 max-w-[calc(524*var(--fx))] font-gotham text-36 font-bold leading-[1.05] text-white md:mt-29 md:text-88 md:font-medium md:leading-84"
        ...
        {descripcion && (
          <div
            className="mt-16 max-w-[calc(406*var(--fx))] font-gotham text-16 font-bold leading-[1.2] text-white md:mt-28 md:text-28 md:font-normal md:leading-35 [&_p]:m-0"
